...
import com.kcbjt.exception.NotFoundException;
import com.kcbjt.exception.PersistenceException;
import com.kcbjt.mapper.BlogMapper;
...
public class BlogServiceImpl implements BlogService {
	...
	@Override
	public List<com.kcbjt.entity.Blog> getListByTitleAndCategoryId(String title, Integer categoryId) {
	...
	@Override
	public List<com.kcbjt.entity.Blog> getIdAndTitleList() {
	...
	@Override
	public com.kcbjt.entity.Blog getBlogById(Long id) {
		com.kcbjt.entity.Blog blog = blogMapper.getBlogById(id);
		if (blog == null) {
