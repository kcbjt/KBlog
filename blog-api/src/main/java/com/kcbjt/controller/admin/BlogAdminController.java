package com.kcbjt.controller.admin;
...
import com.kcbjt.annotation.OperationLogger;
import com.kcbjt.entity.Category;
import com.kcbjt.entity.Tag;
...
import com.kcbjt.service.CategoryService;
import com.kcbjt.service.CommentService;
import com.kcbjt.service.TagService;
...
public class BlogAdminController {
	...
	public Result blogs(@RequestParam(defaultValue = "") String title,
		...
		PageInfo<com.kcbjt.entity.Blog> pageInfo = new PageInfo<>(blogService.getListByTitleAndCategoryId(title, categoryId));
	...
	public Result getBlog(@RequestParam Long id) {
		com.kcbjt.entity.Blog blog = blogService.getBlogById(id);
