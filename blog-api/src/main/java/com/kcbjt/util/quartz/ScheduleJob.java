package com.kcbjt.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import com.kcbjt.entity.ScheduleJobLog;
import com.kcbjt.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.kcbjt.entity.ScheduleJob scheduleJob = (com.kcbjt.entity.ScheduleJob) context.getMergedJobDataMap().get(com.kcbjt.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
