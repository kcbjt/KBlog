package com.kcbjt.util.comment;
...
import com.kcbjt.constant.PageConstants;
...
import com.kcbjt.util.HashUtils;
import com.kcbjt.util.IpAddressUtils;
import com.kcbjt.util.MailUtils;
import com.kcbjt.util.QQInfoUtils;
import com.kcbjt.util.StringUtils;
import com.kcbjt.util.comment.channel.ChannelFactory;
import com.kcbjt.util.comment.channel.CommentNotifyChannel;
import com.kcbjt.enums.CommentOpenStateEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, com.kcbjt.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(com.kcbjt.entity.Comment parentComment, Comment comment) {
